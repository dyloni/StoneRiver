                        ...
                        >
                            ...
                            <div className="flex flex-wrap gap-2">
                                <button
                                    ...
                                    className="flex-1 min-w-[calc(50%-0.25rem)] px-3 py-2 text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 border border-gray-300 rounded-lg transition-colors"
                                >
                                    View
                                </button>
